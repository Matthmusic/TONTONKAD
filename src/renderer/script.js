(function () {
  ...
  // conservent les signatures utilisées par renderCompatChambres.
  function getChamberModels() {
    return CompatChambres.getChamberModels(CHAMBRES_TIRAGE);
  }
  function computeCompatibleChambers(largeur, hauteur, maxN = 3) {
    return CompatChambres.computeCompatibleChambers(getChamberModels(), largeur, hauteur, maxN);
  }
  function buildUnitSchema(W, H, s) {
    return CompatChambres.buildUnitSchema(W, H, s);
  }
  function buildTileSchema(W, s) {
    return CompatChambres.buildTileSchema(W, s);
  }
